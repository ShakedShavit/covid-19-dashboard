...
const url = "https://covid-19-dashboard-shavit.herokuapp.com/first-final-data";
    ...
    if (firstFinalChart) {
        if (isMouseInsideElement(firstFinalChart, e)) {
            if (document.getElementsByClassName("crosshair-line")[0]) {
                ...
                let labelsArr = [];
                if (document.getElementsByClassName("0-9")[0])
                    labelsArr.push(document.getElementsByClassName("0-9")[0]);
                if (document.getElementsByClassName("10-19")[0])
                    labelsArr.push(document.getElementsByClassName("10-19")[0]);
                if (document.getElementsByClassName("20-29")[0])
                    labelsArr.push(document.getElementsByClassName("20-29")[0]);
                if (document.getElementsByClassName("30-39")[0])
                    labelsArr.push(document.getElementsByClassName("30-39")[0]);
                if (document.getElementsByClassName("40-49")[0])
                    labelsArr.push(document.getElementsByClassName("40-49")[0]);
                if (document.getElementsByClassName("50-59")[0])
                    labelsArr.push(document.getElementsByClassName("50-59")[0]);
                if (document.getElementsByClassName("60-69")[0])
                    labelsArr.push(document.getElementsByClassName("60-69")[0]);
                if (document.getElementsByClassName("70-79")[0])
                    labelsArr.push(document.getElementsByClassName("70-79")[0]);
                if (document.getElementsByClassName("80-89")[0])
                    labelsArr.push(document.getElementsByClassName("80-89")[0]);
                if (document.getElementsByClassName("+90")[0])
                    labelsArr.push(document.getElementsByClassName("+90")[0]);
                ...
                for (let i = 0; i < labelsArr.length; i++) {
                    ...
                    if (
                        currentLabelRect[0].top < crosshairLineRect[0].top &&
                        currentLabelRect[0].bottom > crosshairLineRect[0].bottom
                    ) {
...
const isMouseInsideElement = (el, e) => {
    ...
    return (
        e.clientX + window.scrollX > elementPosition.left &&
        e.clientX + window.scrollX < elementPosition.right &&
        e.clientY + window.scrollY > elementPosition.top &&
        e.clientY + window.scrollY < elementPosition.bottom
    );
};

export { redrawFirstFinalGraph, drawFirstFinalGraph };
