...
const url = 'http://localhost:3000/first-card-data';
...
const redrawFirstCardGraph = (isAccessibilityOn) => {
    ...
    const points = getPointsByStartAndEndDates(firstCardData[0].points, firstCardData[0].startingDate, firstCardData[0].endDate);
